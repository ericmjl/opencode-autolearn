...
def _rec(text="x", created="2026-06-01", reinforcements=None, type="memory"):
    return R._new_record(text, type, created_at=created, reinforcements=reinforcements or [])


def test_score_decreases_with_age():
    rec = _rec(created="2026-06-01")
...
def test_reinforcement_boosts_score():
    base = _rec(created="2026-05-01", reinforcements=[])
    boosted = _rec(created="2026-05-01", reinforcements=["2026-06-20"])
...
def test_curve_points_ascending_and_bounded():
    rec = _rec(created="2026-05-01", reinforcements=["2026-05-15"])
